...
export const ACTION_PRERENDER = 'ACTION_PRERENDER';
export const ACTION_CANCEL_PRERENDER = 'ACTION_CANCEL_PRERENDER';
export const ACTION_PRERENDER_SUCCESS = 'ACTION_PRERENDER_SUCCESS';
export const ACTION_PRERENDER_FAILED = 'ACTION_PRERENDER_FAILED';

export const ACTION_CONFIRM_LOAD_SOURCE = 'ACTION_CONFIRM_LOAD_SOURCE';
